...
onboard:
	docker run --rm -it -p $(NETWORKTABLE):862 -v /lightning-vision/voidvision:/app/voidvision --device="/dev/video0:/dev/video0" --runtime $(RUNTIME) --network $(NETWORK) --name $(CONTAINER) $(IMAGE)
